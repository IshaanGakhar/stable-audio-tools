...
class ConditionedDiffusionModelWrapper(nn.Module):
    ...
    def __init__(
            ...
            lyrics_cond_ids: tp.List[str] = [], # TODO: is this needed?
            lyric_encoder=None,
            vocals_encoder=None,
            ):
        super().__init__()
        ...
        self.model = model
        self.lyrics_encoder = lyric_encoder
        ...
        self.lyrics_cond_ids = lyrics_cond_ids # TODO: is this needed?
        self.min_input_length = min_input_length
    ...
    def get_conditioning_inputs(self, conditioning_tensors: tp.Dict[str, tp.Any], negative=False): # TODO add lyric latents as input for DiT
        ...
        if self.lyric_encoder is not None and len(self.lyrics_cond_ids) > 0:
            ...
            lyrics_batch = conditioning_tensors.get("cropped_lyrics", "")
            lyrics_latents = self.lyrics_encoder.encode(lyrics_batch)
...
def create_diffusion_cond_from_config(config: tp.Dict[str, tp.Any], lyric_encoder=None, vocals_encoder=None): # TODO: need to extract lyric encoder params
