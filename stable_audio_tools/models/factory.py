...
def create_model_from_config(model_config):
    ...
    if model_type == 'autoencoder':
        ...
        if vocals_encoder_config is not None:
            ...
            from .vocals_encoder import VocalsEncoder
        ...
        return create_diffusion_cond_from_config(model_config, lyric_encoder=lyric_encoder, vocals_encoder=vocals_encoder)
